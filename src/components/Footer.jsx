    ...
    <footer className="bg-gray-900 text-white py-12 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-400">
            Delivering world-class cancer care through advanced technology.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-gray-400">
            ...
            <Link to="/team" className="hover:text-white">Our Teams</Link>
            <Link to="/services" className="hover:text-white">Services</Link>
            <Link to="/appointment" className="hover:text-white">Book Appointment</Link>
          </div>
        </div>
        ...
        <div>
          <h1 className="text-lg font-semibold mb-4">Popular Services</h1>
          <div className="flex flex-col gap-2 text-gray-400">
            <Link to="/services" className="hover:text-white">Cancer Surgery</Link>
            <Link to="/services" className="hover:text-white">Chemotherapy</Link>
            <Link to="/services" className="hover:text-white">Immunotherapy</Link>
            <Link to="/services" className="hover:text-white">Radiation Therapy</Link>
          </div>
        </div>
        ...
        <div>
          ...
          {/* Social Icons */}
          <div className="flex gap-4 mt-4">
            <a href="https://facebook.com" target="_blank" className="bg-gray-800 p-2 rounded-full hover:bg-violet-500">
              <FaFacebookF />
            </a>
            <a href="https://instagram.com" target="_blank" className="bg-gray-800 p-2 rounded-full hover:bg-violet-500">
              <FaInstagram />
            </a>
            <a href="https://twitter.com" target="_blank" className="bg-gray-800 p-2 rounded-full hover:bg-violet-500">
              <FaTwitter />
            </a>
            <a href="https://linkedin.com" target="_blank" className="bg-gray-800 p-2 rounded-full hover:bg-violet-500">
              <FaLinkedinIn />
            </a>
          </div>
        </div>
